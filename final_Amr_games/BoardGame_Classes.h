...
#ifndef FINAL_BOAED_GAME_VERSION_BOARDGAME_CLASSES_H
#define FINAL_BOAED_GAME_VERSION_BOARDGAME_CLASSES_H
#include <string>
#include <vector>
...
#endif //FINAL_BOAED_GAME_VERSION_BOARDGAME_CLASSES_H
